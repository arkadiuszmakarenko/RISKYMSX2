...
/  RISKYMSX2: write access enabled - the CLI creates test files on the
/  stick (see USB_FatTest).  Requires FF_FS_LOCK == 0 (see below). */
...
/  RISKYMSX2: level 0 so f_unlink() (delete test file) stays available. */
