...
void Udisk_USBH_Initialization (void) {
    ...
    printf ("[diag] USBHS_Host_Init OK\r\n");
    /* For Udisk Lib */
...
ENUM_START:
    ...
    printf ("[enum] attach-loop done i=%u s=%u\r\n", (unsigned)i, (unsigned)s);
    if (i) {
